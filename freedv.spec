...
Version  : 1.8.6
Release  : 30
URL      : https://github.com/drowe67/freedv-gui/archive/v1.8.6/freedv-gui-1.8.6.tar.gz
Source0  : https://github.com/drowe67/freedv-gui/archive/v1.8.6/freedv-gui-1.8.6.tar.gz
...
%prep
%setup -q -n freedv-gui-1.8.6
cd %{_builddir}/freedv-gui-1.8.6
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672076127
mkdir -p clr-build
pushd clr-build
