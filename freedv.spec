...
Version  : 1.9.7
Release  : 61
URL      : https://github.com/drowe67/freedv-gui/archive/v1.9.7/freedv-gui-1.9.7.tar.gz
Source0  : https://github.com/drowe67/freedv-gui/archive/v1.9.7/freedv-gui-1.9.7.tar.gz
...
%prep
%setup -q -n freedv-gui-1.9.7
cd %{_builddir}/freedv-gui-1.9.7
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705418199
mkdir -p clr-build
pushd clr-build
