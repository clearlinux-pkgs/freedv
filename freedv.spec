...
Version  : 1.9.4
Release  : 56
URL      : https://github.com/drowe67/freedv-gui/archive/v1.9.4/freedv-gui-1.9.4.tar.gz
Source0  : https://github.com/drowe67/freedv-gui/archive/v1.9.4/freedv-gui-1.9.4.tar.gz
...
%prep
%setup -q -n freedv-gui-1.9.4
cd %{_builddir}/freedv-gui-1.9.4
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698242948
mkdir -p clr-build
pushd clr-build
