...
Source0  : https://github.com/drowe67/freedv-gui/archive/v1.6.1/freedv-gui-1.6.1.tar.gz
...
%prep
%setup -q -n freedv-gui-1.6.1
cd %{_builddir}/freedv-gui-1.6.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632773782
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/freedv-gui-1.6.1/COPYING %{buildroot}/usr/share/package-licenses/freedv/0468d1cb0e40500dc98fa86141431a9f9e088c2b
cp %{_builddir}/freedv-gui-1.6.1/contrib/LICENSE %{buildroot}/usr/share/package-licenses/freedv/e9101bd4e253c0f7da54e8f581cf72322df10162
pushd clr-build
%make_install
popd
