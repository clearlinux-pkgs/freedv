...
Version  : 1.8.4
Release  : 28
URL      : https://github.com/drowe67/freedv-gui/archive/v1.8.4/freedv-gui-1.8.4.tar.gz
Source0  : https://github.com/drowe67/freedv-gui/archive/v1.8.4/freedv-gui-1.8.4.tar.gz
...
%prep
%setup -q -n freedv-gui-1.8.4
cd %{_builddir}/freedv-gui-1.8.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667228392
mkdir -p clr-build
pushd clr-build
