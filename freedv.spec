...
Source0  : https://github.com/drowe67/freedv-gui/archive/v1.8.5/freedv-gui-1.8.5.tar.gz
...
%prep
%setup -q -n freedv-gui-1.8.5
cd %{_builddir}/freedv-gui-1.8.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670489063
mkdir -p clr-build
pushd clr-build
