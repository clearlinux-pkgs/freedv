...
Version  : 1.9.7.1
Release  : 62
URL      : https://github.com/drowe67/freedv-gui/archive/v1.9.7.1/freedv-gui-1.9.7.1.tar.gz
Source0  : https://github.com/drowe67/freedv-gui/archive/v1.9.7.1/freedv-gui-1.9.7.1.tar.gz
...
%prep
%setup -q -n freedv-gui-1.9.7.1
cd %{_builddir}/freedv-gui-1.9.7.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705584441
mkdir -p clr-build
pushd clr-build
