...
Source0  : https://github.com/drowe67/freedv-gui/archive/v1.8.3.1/freedv-gui-1.8.3.1.tar.gz
...
%prep
%setup -q -n freedv-gui-1.8.3.1
cd %{_builddir}/freedv-gui-1.8.3.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660781621
mkdir -p clr-build
pushd clr-build
